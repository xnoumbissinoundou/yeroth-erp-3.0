...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Historique du Stock ''YEROTHSTOCKHISTORYDESIGNATION'' avec le ID: ''YEROTHSTOCKHISTORYSTOCKID'',
         	  imprim\'e par: ''YEROTHNOMUTILISATEUR''.},
...
\section*{Historique du Stock ''YEROTHSTOCKHISTORYDESIGNATION'' avec le ID: ''YEROTHSTOCKHISTORYSTOCKID''}

\textbf{R\'ef\'erence du stock:} YEROTHSTOCKHISTORYREFERENCE\\
