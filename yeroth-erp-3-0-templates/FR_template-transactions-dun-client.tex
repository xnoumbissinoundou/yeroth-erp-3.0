...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Transactions du YEROTHVENTESDEBUT au YEROTHVENTESFIN (Client ''YEROTHCLIENT''),
...
\section*{Transactions du YEROTHVENTESDEBUT au YEROTHVENTESFIN (Client ''YEROTHCLIENT'')}
