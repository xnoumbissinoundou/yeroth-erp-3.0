...
\begin{document}
	...
	{\tiny \emptyset \hfill \textcolor{yerothColorGold}{YEROTH~R\&D -- MEMBERSHIP~ROYALTY~CARD}}\\
    \vspace{-0.25em}
    \rule{74mm}{.3mm}\\
    ...
    \begin{minipage}[t]{42mm}
        ...
        {\tiny
        	\begin{tabular}{rl}
            	{\color{gray}account number} & $7777777$\\
            	{\color{gray}city} & Yeroth\\
            	{\color{gray}street} & Yeroth\\
            	{\color{gray}scc} & Yeroth\\
            	{\color{gray}telephone} & $6\ 80\ 59\ 65\ 72$\\
            \end{tabular}
            \vspace*{2mm}
        }
        \end{flushleft}
    ...
    \vspace{-0.45em}
    \hspace*{-0.45em}
    \texttt{\fontsize{1.83mm}{3.55mm}\selectfont CUSTOMER ACCOUNT MANAGEMENT - BIG ACCOUNT PROGRAM ($75$+ installations)\\
    \hspace*{-0.66em}
    \texttt{\fontsize{1.83mm}{3.55mm}\selectfont EMAIL: yerotherp30@gmail.com - HEAD OFFICE: Yeroth - TEL: $6\ 80\ 59\ 65\ 72$}}
    \end{Spacing}
\end{document}