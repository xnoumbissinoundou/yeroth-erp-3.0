...
\begin{document}
    ...
    \hspace*{-0.54em}
    \texttt{\fontsize{1.83mm}{3.55mm}\selectfont YEROTHSIEGEDUSERVICEGESTIONRELATIONCLIENTELLE \bullet{} \'EMAIL: YEROTHEMAILDUSERVICEGESTIONRELATIONCLIENTELLE \bullet{} T\'EL: YEROTHTELEPHONEDUSERVICEGESTIONRELATIONCLIENTELLE}}
    \end{Spacing}
\end{document}