...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={History of Stock ''YEROTHSTOCKHISTORYDESIGNATION'' with ID: ''YEROTHSTOCKHISTORYSTOCKID'',
              printed by: ''YEROTHNOMUTILISATEUR''.},
...
\section*{History of Stock ''YEROTHSTOCKHISTORYDESIGNATION'' with ID: ''YEROTHSTOCKHISTORYSTOCKID''.}

\textbf{Stock reference:} YEROTHSTOCKHISTORYREFERENCE\\
