...
bookmarks,
plainpages=false,
pdftitle={Customer Data of YEROTHCLIENT for company 'YEROTHENTREPRISE'.},
...
\section*{\underline{Customer Data for:} 'YEROTHCLIENT'}
...
\parbox{15em}{
\begin{center}
\includegraphics[height=63mm]{YEROTHCHEMINCOMPLETIMAGECOMPTECLIENT}
\caption*{Image associated for customer 'YEROTHCLIENT'}
\end{center}
}
\end{tabular}
\end{table}
