...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={La fiche des marchandises (SERVICES) imprim\'ee par YEROTHNOMUTILISATEUR (YEROTHENTREPRISE, YEROTHDATE)},
...
\section*{Fiche des Marchandises YEROTHMARCHANDISESNOMTERMINEES (SERVICES)}
