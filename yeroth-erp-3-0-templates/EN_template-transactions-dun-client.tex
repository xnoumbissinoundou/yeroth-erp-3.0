...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Transactions of Customer 'YEROTHCLIENT' from YEROTHVENTESDEBUT to YEROTHVENTESFIN,
...
\section*{Transactions of Customer 'YEROTHCLIENT' from YEROTHVENTESDEBUT to YEROTHVENTESFIN}
