...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Transactions of Supplier 'YEROTHFOURNISSEUR' from YEROTHVENTESDEBUT to YEROTHVENTESFIN,
...
\section*{Transactions of Supplier 'YEROTHFOURNISSEUR' from YEROTHVENTESDEBUT to YEROTHVENTESFIN}
