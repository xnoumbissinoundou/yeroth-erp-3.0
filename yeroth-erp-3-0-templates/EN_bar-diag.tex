...
\usepackage{pstricks} % for one of the "alternative" shapes
\usepackage{bardiag}
\usepackage{graphicx}
...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Diagram illustrating the income from
		YEROTHCHIFFREAFFAIREDATEDEBUT to YEROTHCHIFFREAFFAIREDATEFIN
...
\section*{Diagram illustrating the income from YEROTHCHIFFREAFFAIREDATEDEBUT
		  to YEROTHCHIFFREAFFAIREDATEFIN YEROTHMENTION}
