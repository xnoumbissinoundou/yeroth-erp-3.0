...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={FINANCIAL ACCOUNTING OPERATION ACCOUNT LISTING printed by YEROTHNOMUTILISATEUR
     (YEROTHENTREPRISE, YEROTHDATE)},
...
\section*{FINANCIAL ACCOUNTING OPERATION ACCOUNT LISTING}
