...
bookmarks,
plainpages=false,
pdftitle={Facture (format a$4$) pour le client YEROTHCLIENT, YEROTHENTREPRISE},
...
\section*{\underline{Facture N\textsuperscript{\underline{o}}:} YEROTHNUMEROSORTIETRANSFERT (YEROTHTYPEPAIEMENT)}
