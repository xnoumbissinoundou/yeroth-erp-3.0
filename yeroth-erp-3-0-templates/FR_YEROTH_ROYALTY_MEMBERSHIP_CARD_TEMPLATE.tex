...
\begin{document}
    \begin{Spacing}{0.75}%
    \noindent
	\includegraphics[height=3mm]{YEROTHCARTEDEFIDELITELOGO}
    ...
    \begin{minipage}[t]{42mm}
        ...
        {\tiny
        	\begin{tabular}{rl}
            	...
            	{\color{gray}rue ou quartier} & YEROTHCLIENTRUEOUQUARTIER \\
            	{\color{gray}bo\^ite~postale} & YEROTHBOITEPOSTALE \\
            	{\color{gray}ville} & YEROTHCLIENTVILLE \\
            	{\color{gray}t\'el\'ephone} & YEROTHCLIENTTELEPHONE \\
            \end{tabular}
            \vspace*{2mm}
        }
        \end{flushleft}
