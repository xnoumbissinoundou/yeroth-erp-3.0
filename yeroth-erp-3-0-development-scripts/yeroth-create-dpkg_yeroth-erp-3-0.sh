...
${CP} ${ENGLISH_ERP_PRODUCT_COMPARISON_SHEET_PDF_FILE_PATH} "${TARGET_INSTALLATION_DIR_DOC}/english"
${CP} ${FRANCAIS_COMPARAISON_ERP_PDF_CHEMIN} "${TARGET_INSTALLATION_DIR_DOC}/francais"
