...
TARGET_INSTALLATION_DIR_DOC="${OPT_INSTALLATION_TARGET_DIR}/doc"
...
CREATE USER \${USER_NAME}@localhost IDENTIFIED BY '\${PASSWDDB}'; \
GRANT ALL PRIVILEGES ON \${MAINDB}.* TO '\${USER_NAME}'@'localhost'; \
FLUSH PRIVILEGES;\"
mysql_ret_code=\"\$?\"
exit 0"
else
