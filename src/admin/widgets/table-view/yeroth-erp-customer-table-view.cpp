/*
 * yeroth-erp-customery-table-view.cpp
 *
 *      Author: Xavier NOUMBISSI NOUNDOU, Dipl.-Inf., Ph.D. (ABD)
 */


#include "yeroth-erp-customer-table-view.hpp"
...
YerothERPCustomerTableView::YerothERPCustomerTableView()
:YerothTableView()
{
	_stdItemModel->_curTableView = this;
}

YerothERPCustomerTableView::YerothERPCustomerTableView(QWidget * parent)
...
void YerothERPCustomerTableView::lister_les_elements_du_tableau(YerothSqlTableModel &tableModel)
{
