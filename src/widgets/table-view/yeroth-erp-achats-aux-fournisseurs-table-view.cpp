/*
 * yeroth-erp-achats-aux-fournisseurs-table-view.cpp
 *
 *      Author: DR. XAVIER NOUMBISSI NOUNDOU
 */


#include "yeroth-erp-achats-aux-fournisseurs-table-view.hpp"
...
void YerothERPAchatsAUXFournisseursTableView::lister_les_elements_du_tableau(YerothSqlTableModel &tableModel)
{
...
void YerothERPAchatsAUXFournisseursTableView::selectionChanged (const QItemSelection & selected,
                                        		 	 	 	    const QItemSelection & deselected)
{
    ...
    if (selectedIndexes.size() > 0)
    {
    	...
    	{
    		curAllWindows->_achats_aux_fournisseursWindow->
