/*
 * yeroth-erp-programmes-de-fidelite-clients-table-view.cpp
 *
 *      Author: DR. XAVIER NOUMBISSI NOUNDOU
 */


#include "yeroth-erp-programmes-de-fidelite-clients-table-view.hpp"
...
void YerothERPProgrammesDeFideliteClientsTableView::lister_les_elements_du_tableau(YerothSqlTableModel &tableModel)
{
...
void YerothERPProgrammesDeFideliteClientsTableView::selectionChanged (const QItemSelection & selected,
                                        		  	  	   	   	   	  const QItemSelection & deselected)
{
    ...
    if (selectedIndexes.size() > 0)
    {
    	...
    	{
    		curAllWindows->_programmesDeFideliteClientsWindow
