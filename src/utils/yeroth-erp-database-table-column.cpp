...
# ifdef YEROTH_FRANCAIS_LANGUAGE
	...
	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::SECTEURS_DACTIVITES,	QObject::trUtf8("Secteurs d'activites"));
...
# ifdef YEROTH_ENGLISH_LANGUAGE
	...
	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::REMISE_PRIX, 		QString("Discount (%1)").arg(YerothERPConfig::currency));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::ID,					QObject::tr("id"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::HISTORIQUE_STOCK,		QObject::tr("Stock history"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::VENTE_ID,				QObject::tr("Sale ID"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::ENREGISTREUR_STOCK,				QObject::tr("Stock manager"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::REFERENCE,				QObject::tr("Reference"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::COMPTE_CLIENT,			QObject::tr("Customer account"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DETTE_MAXIMALE_COMPTE_CLIENT,		QObject::tr("Max. debt"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::CATEGORIE,			QObject::tr("Category"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DESIGNATION,			QObject::tr("Designation"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::QUANTITE,				QObject::tr("Quantity"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::STOCK_MAXIMUM,	QObject::trUtf8("Stock (maximum)"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::STOCK_MINIMUM,	QObject::trUtf8("Stock (minimum)"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::QUANTITE_VENDUE,		QObject::tr("qty"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::QUANTITE_TOTAL,		QObject::tr("Total qty"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::QUANTITE_SORTIE,		QObject::tr("Outgoing qty"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DESCRIPTION_PRODUIT,	QObject::tr("Product description"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::PRIX_UNITAIRE,		QObject::tr("Unit price"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::REFERENCE_RECU_DACHAT, 		QObject::tr("Buying reference"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::PRIX_DACHAT,			QObject::tr("Buying price"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::PRIX_VENTE,			QObject::tr("Selling price"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DESCRIPTION_CATEGORIE, 		QObject::trUtf8("Description"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_CATEGORIE, 		QObject::trUtf8("Name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::MONTANT_TVA,			QObject::tr("Tax"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::TVA,					QObject::tr("Tax"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::MARGE_BENEFICIAIRE,		QObject::trUtf8("Profit"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::MONTANT_RECU,			QObject::tr("Received amount"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::MONTANT_A_REMBOURSER,	QObject::tr("Due amount"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::MONTANT_TOTAL_VENTE,	QObject::tr("Business turn."));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::REMISE_PRIX,			QObject::tr("Discount"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::REMISE_POURCENTAGE,	QObject::tr("Discount (%)"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::LOCALISATION,			QObject::tr("Location"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::LOCALISATION_STOCK,	QObject::tr("Stock location"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::LOTS_ENTRANT,		QObject::tr("Incoming batch"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::IMAGE_PRODUIT,		QObject::tr("Product image"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_PEREMPTION,		QObject::tr("Expiration date"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_ENTREE,			QObject::tr("Entry date"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::PRENOM,				QObject::tr("First name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM,					QObject::tr("Name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_RECEPTEUR,		QObject::tr("Receiver name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_MAGASINIER,		QObject::tr("Store keeper"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_UTILISATEUR_MAGASINIER,	QObject::tr("Store keeper ID"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_UTILISATEUR_CAISSIER,	QObject::tr("Cashier ID"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_CAISSIER,			QObject::tr("Cashier name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_COMPLET,			QObject::tr("Full name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_LOCALISATION,	QObject::tr("Name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::VALEUR_DIVENTAIRE,	QObject::tr("Inventory value"));
	...
	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::MOT_PASSE,			QObject::tr("Password"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::TITRE,				QObject::tr("Title"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::APPELATION_TITRE,		QObject::tr("Given title"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::ROLE,					QObject::tr("Role"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::EMAIL,				QObject::tr("Email"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::REFERENCE_CLIENT,	QObject::trUtf8("Customer reference"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NUMERO_TELEPHONE_1,	QObject::tr("Phone number 1"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NUMERO_TELEPHONE_2,	QObject::tr("Phone number 2"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::LIEU_NAISSANCE,		QObject::tr("City of birth"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_NAISSANCE,		QObject::tr("Date of birth"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::VILLE,				QObject::tr("City"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::QUARTIER,				QObject::tr("City area"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::PROVINCE_ETAT,		QObject::tr("Province/State"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::PAYS,					QObject::tr("Country"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::BOITE_POSTALE,		QObject::tr("Postal code"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::SORTIE_ID,			QObject::tr("Outgoing ID"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::SIEGE_SOCIAL,			QObject::tr("Company headquarters"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOTES,				QObject::tr("Notes"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_ENTREPRISE,		QObject::tr("Company name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NUMERO_DE_COMPTE_BANCAIRE,	"Bank account nr.");

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::AGENCE_DE_COMPTE_BANCAIRE,	"Bank account branch");

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::SECTEURS_DACTIVITES,	"Business sectors");

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NUMERO_CONTRIBUABLE,	QObject::tr("Tay payer number"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_REPRESENTANT,		QObject::tr("Representant name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_ENTREPRISE_CLIENT,	QObject::tr("Customer"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_ENTREPRISE_FOURNISSEUR,	QObject::tr("Supplier"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DESCRIPTION_CLIENT,	QObject::tr("Client description"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DESIGNATION_ALERTE,	QObject::tr("Alert designation"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::CONDITION_ALERTE,		QObject::tr("Alert condition"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_ENCAISSEUR,			QObject::tr("Receiver"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_PAYEUR,				QObject::tr("Payer"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_PAIEMENT,			QObject::tr("Payment date"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::MONTANT_PAYE,			QObject::tr("Amount"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_VENTE,			QObject::tr("Selling date"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_DEBUT,			QObject::tr("Starting date"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_FIN,				QObject::tr("Ending date"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_SORTIE,			QObject::tr("Outgoing date"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::HEURE_PAIEMENT,			QObject::tr("Payment time"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::HEURE_VENTE,			QObject::tr("Time of sale"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::HEURE_SORTIE,			QObject::tr("Outgoing hour"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DESTINATAIRE,			QObject::tr("Receiver"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOM_COMPLET_DESTINATAIRE,	QObject::tr("Receiver full name"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::MESSAGE_ALERTE,		QObject::tr("Alert message"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::DATE_CREATION,		QObject::tr("Creation date"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::NOTIFICATIONS,		QObject::tr("Notifications"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::ALERTE_RESOLUE,		QObject::tr("Solved alert"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::LOCALISATION_SORTIE,	QObject::tr("Outgoing location"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::LOCALISATION_ENTREE,	QObject::tr("Incoming location"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::LOCALISATION_SORTIE_ID,	QObject::tr("Site ID (outgoing)"));

	_tableColumnToUserViewString.insert(YerothDatabaseTableColumn::LOCALISATION_ENTREE_ID,	QObject::tr("Site ID (incoming)"));
# endif
