...
public:
	...
	static QString template_CLIENT_LOYALTY_GROUP_LISTING_tex;
	...
	enum TYPEDENCAISSEMENT
	{
		...
		ENCAISSEMENT_ACHAT_DE_SERVICE_ANNULE 	= 60,
	...
	static const QKeySequence AFFICHER_LES_MARCHANDISES_NON_TERMINES_QKEYSEQUENCE;
