 ...
 _curFournisseurDetailDBID(-2)
{
    _windowName = QString("%1 - %2")
    				.arg(YEROTH_ERP_WINDOW_TITLE,
    					 QObject::trUtf8("modifier un fournisseur"));
    ...
    connect(actionActualiserFournisseur, SIGNAL(triggered()), this, SLOT(actualiserFournisseur()));
...
void YerothModifierFournisseurWindow::definirManager()
{
    ...
    pushButton_supprimer_image->enable(this, SLOT(supprimer_image_fournisseur()));
}
...
void YerothModifierFournisseurWindow::clear_all_fields()
{
	...
	lineEdit_modifier_fournisseur_dette_maximale->clear();
...
void YerothModifierFournisseurWindow::supprimer_image_fournisseur()
{
    ...
    {
        QString msg(QObject::trUtf8("Le fournisseur '%1' n'a pas d'image enregistrée !")
        				.arg(nomEntreprise));
    ...
    if (QMessageBox::Ok ==
            YerothQMessageBox::question(this, QObject::tr("suppression de l'image"),
                                       msgSupprimer, QMessageBox::Cancel, QMessageBox::Ok))
    {
        ...
        if (resRemoved)
        {
            ...
            YerothQMessageBox::information(this,
                                          QObject::trUtf8("suppression de l'image - succès"),
                                          msgSupprimer);
        }
        else
        {
            ...
            YerothQMessageBox::information(this,
                                          QObject::trUtf8("suppression de l'image - échec"),
                                          msgSupprimer);
        }
    }
    else
...
bool YerothModifierFournisseurWindow::customerAccountAlreadyExist()
{
	...
	bool resultNomEntreprise =
				YerothUtils::checkIfCustomerAccountAlreadyExist_NOMENTREPRISE(*this, *_curFournisseurTableModel,
	...
	bool resultReferenceRegistreDuCommerce =
			YerothUtils::checkIfCustomerAccountAlreadyExist_REFERENCE_REGISTRE_DU_COMMERCE(*this, *_curFournisseurTableModel,
	...
	bool resultReferenceFournisseur =
			YerothUtils::checkIfCustomerAccountAlreadyExist_REFERENCECLIENT(*this, *_curFournisseurTableModel,
...
//        				.arg(oldFournisseurRef, lineEdit_modifier_fournisseur_reference_fournisseur->text());
//
//        qDebug() << QString("++ oldCompanyName: %1, company name: %2")
//        				.arg(oldCompanyName, lineEdit_modifier_fournisseur_nom_entreprise->text());

        if (! YerothUtils::isEqualCaseInsensitive(oldFournisseurRef, lineEdit_modifier_fournisseur_reference_fournisseur->text()))
        {
        	currentFournisseurRefChanged = true;
        }

        if (! YerothUtils::isEqualCaseInsensitive(oldCompanyName, lineEdit_modifier_fournisseur_nom_entreprise->text()))
        {
        ...
        record.setValue(YerothDatabaseTableColumn::PROVINCE_ETAT, lineEdit_modifier_fournisseur_province_etat->text());
		...
		record.setValue(YerothDatabaseTableColumn::DETTE_MAXIMALE_COMPTE_CLIENT,
				lineEdit_modifier_fournisseur_dette_maximale->text().toDouble());

        record.setValue(YerothDatabaseTableColumn::DESCRIPTION_CLIENT, textEdit_modifier_fournisseur_description_du_fournisseur->toPlainText());
        ...
        QString retMsg(QObject::trUtf8("Les données du fournisseur '%1'")
        ...
        if (success)
        {
            ...
            YerothQMessageBox::information(this,
                                     QObject::trUtf8("modification - succès"),
                                     retMsg);
        ...
        {
            qDebug() << "\t[reason for failing] " << _curFournisseurTableModel->lastError();

            retMsg.append(QObject::trUtf8(" n'ont pas pu être modifiées !"));

            YerothQMessageBox::warning(this,
                                 QObject::trUtf8("modification - échec"),
                                 retMsg);
        }
    }
}
...
void YerothModifierFournisseurWindow::supprimerFournisseur()
{
    ...
    QString msgSupprimer(QObject::trUtf8("Poursuivre avec la suppression du fournisseur '%1' ?")
                                        ...
                                        QMessageBox::Cancel, QMessageBox::Ok))
    {
        ...
        {
            msgSupprimer.clear();
            msgSupprimer.append(QObject::trUtf8("Le fournisseur '%1' a été supprimé !")
            						.arg(GET_SQL_RECORD_DATA(record, YerothDatabaseTableColumn::NOM_ENTREPRISE)));
        ...
        {
            msgSupprimer.clear();
            msgSupprimer.append(QObject::trUtf8("Le fournisseur '%1' ne pouvait pas être supprimé !")
            						.arg(GET_SQL_RECORD_DATA(record, YerothDatabaseTableColumn::NOM_ENTREPRISE)));
...
void YerothModifierFournisseurWindow::showFournisseurDetail()
{
	...
	lineEdit_modifier_fournisseur_province_etat->setText(GET_SQL_RECORD_DATA(record, YerothDatabaseTableColumn::PROVINCE_ETAT));
	...
	lineEdit_modifier_fournisseur_dette_maximale->setText(GET_SQL_RECORD_DATA(record, YerothDatabaseTableColumn::DETTE_MAXIMALE_COMPTE_CLIENT));
