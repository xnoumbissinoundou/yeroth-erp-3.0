...
bool YerothPayerFournisseurWindow::putCashIntoCustomerAccount()
{
    ...
    fournisseursTableModel.yerothSetFilter(fournisseurFilter);
...
void YerothPayerFournisseurWindow::populatePayerAuFournisseursComboBoxes()
{
	...
	comboBox_fournisseurs_typedepaiement->populateComboBoxWithout(YerothUtils::VERSEMENT_ACHAT_ANNULE);
...
void YerothPayerFournisseurWindow::getPayerAuFournisseurListingTexTableString(QString &texTable_in_out,
...
void YerothPayerFournisseurWindow::getPayerAuFournisseurTexDocumentString(QString &texDocumentString_in_out,
        											   	   	    QString &printString)
{
    texDocumentString_in_out.clear();
    texDocumentString_in_out.append(YerothUtils::template_fournisseurs_tex);
