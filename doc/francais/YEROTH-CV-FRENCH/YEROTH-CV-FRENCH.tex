...
\newcommand{\yerotherptroiszero}{YEROTH--ERP--$3$.$0$\xspace}
...
\begin{enumerate}
	...
	\item \headerrowONE{\textbf{\yerotherptroiszero SOFTWARE--SYSTEM ARCHITECTURE},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}

	\item \headerrowONE{\textbf{FICHE DE DONNÉES DU SYSTÈME--LOGICIEL YEROTH--ERP--3.0},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}
	
	\item \headerrowONE{\textbf{AVANTAGES DE \yerotherptroiszero COMPARATIVEMENT
