...
\fancypagestyle{OnlyFirstPage}{%
	\lhead{}
	\rhead{}
    \lfoot{\url{http://sites.google.com/view/yeroth-rd}}
}
...
\yerothUWATERLOOWATFORMitem
 \headerrowONE{\href{http://archive.org/details/junit-by-xavier-noumbissi-noundou}{
...
\yerothUWATERLOOWATFORMitem
 	\headerrowONE{\href{http://archive.org/details/cs846-nnoumbissi}{
...
\yerothUWATERLOOWATFORMitem
	 \headerrowONE{\href{http://archive.org/details/saint_201507}{
...
\begin{enumerate}
	...
	\yerothitem
	  \headerrowONE{\href{http://archive.org/details/yeroth-erp-3-0-guide-de-lutilisateur-manager}
						{\textbf{GUIDE DE L'UTILISATEUR 'MANAGER', SYSTÈME LOGICIEL ERP \yerotherptroispointzero}},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}

	\yerothitem
	 \headerrowONE{\href{http://archive.org/details/yeroth-erp-3-0-brochure}
		{\textbf{BROCHURE D'INFORMATION DU SYSTÈME--LOGICIEL \yerotherptroispointzero}},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}
		
	\yerothitem
	 \headerrowONE{\href{http://archive.org/details/yeroth-erp-3-0-fiche-de-donnees}
		{\textbf{FICHE DE DONNÉES DU SYSTÈME--LOGICIEL \yerotherptroispointzero}},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}

	\yerothitem
	 \headerrowONE{\href{http://archive.org/details/yeroth-erp-3-0-document-comparaisons}
		{\textbf{AVANTAGES DE \yerotherptroispointzero COMPARATIVEMENT
			À SAGE GESCOM I$7$, ET À SAP BUSINESS ONE}},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}

	\yerothitem
	 \headerrowONE{\href{http://archive.org/details/yeroth-erp-3-0-PDV-materiel-informatique-recommande}
						{\textbf{MATÉRIEL INFORMATIQUE RECOMMANDÉ POUR LE POINT-DE-VENTE \yerotherptroispointzero}},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}
		
	\yerothitem
	 \headerrowONE{\href{http://archive.org/details/yeroth-erp-3-0-guide-dinstallation-standalone}
						{\textbf{GUIDE D'INSTALLATION POUR LE SYSTÈME--LOGICIEL \yerotherptroispointzero}},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}
						
	\yerothitem
	 \headerrowONE{\href{http://archive.org/details/yeroth-erp-3-0-software-system-architecture_202104}
	{\textbf{SOFTWARE--SYSTEM ARCHITECTURE OF \yerotherptroispointzero}},\\
		TECHNICAL REPORT, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}							
	...
	\yerothitem
	 \headerrowONE{\href{http://archive.org/details/yeroth-erp-3-0-info-francais_202104}
