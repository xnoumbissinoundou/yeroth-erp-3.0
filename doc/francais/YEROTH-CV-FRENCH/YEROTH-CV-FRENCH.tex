...
\headerrowONE{\href{http://archive.org/download/yeroth-erp-3-0-info-francais/yeroth-erp-3-0-info-francais.pdf}{\textbf{SYSTÈME--LOGICIEL ERP '\texttt{YEROTH--ERP--3.0--STANDALONE}'}}}		
...
\headerrowONE{\textbf{'YEROTH-ERP-3.0--SYSTEM--DAEMON': ALERTES ET SAUVEGARDE AUTOMATISÉE}
...
\headerrowONE{'\textbf{\yerothdebian}', '\textbf{MICROSOFT WINDOWS}'}
...
\yerothUWATERLOOWATFORMitem
 \headerrowONE{\href{http://archive.org/download/junit-by-xavier-noumbissi-noundou/junit4-tutorial-by-xavier-noumbissi-noundou.pdf}{
