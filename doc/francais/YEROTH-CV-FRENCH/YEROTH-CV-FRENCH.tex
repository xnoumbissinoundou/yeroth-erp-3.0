...
\headerrowONE{\href{http://archive.org/download/yeroth-erp-3-0-info-francais/yeroth-erp-3-0-info-francais.pdf}{\textbf{SYSTÈME--LOGICIEL ERP '\texttt{YEROTH--PGI--3.0--STANDALONE}'}}}		
...
\begin{enumerate}
	...
	\yerothitem
	 \headerrowONE{\href{http://archive.org/download/yeroth-erp-3-0-document-comparaisons-1/yeroth-erp-3-0-document-comparaisons-1.pdf}
		...
		RAPPORT DE TRAVAIL INTERNE À YEROTH R\&d, \yerothrd, CAMEROUN, \textbf{AVRIL~$2021$}.}
	...
	\yerothitem
	 \headerrowONE{\href{http://archive.org/download/yeroth-erp-3-0-document-comparaisons/yeroth-erp-3-0-document-comparaisons.pdf}
		...
		RAPPORT DE TRAVAIL INTERNE À YEROTH R\&d, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}
	...
	\yerothitem
	  \headerrowONE{\href{http://archive.org/download/yeroth-erp-3-0-guide-de-lutilisateur-manager/yeroth-erp-3-0-guide-de-lutilisateur-manager.pdf}
						{\textbf{GUIDE DE L'UTILISATEUR 'MANAGER', SYSTÈME LOGICIEL ERP \yerothpgitroispointzero}},\\
		RAPPORT DE TRAVAIL INTERNE À YEROTH R\&d, \yerothrd, CAMEROUN, \textbf{MARS~$2021$}.}
