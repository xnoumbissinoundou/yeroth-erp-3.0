...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
	pdftitle={Manuel de l'Utilisateur ''Manager'' de YEROTH--ERP (version $3.0$)
...
\newcommand{\patron}{\emph{Manager}\xspace}
...
\newcommand{\patronb}{\emph{\textbf{Manager}}\xspace}
...
\newcommand{\lienpatron}{\patron~\ref{sec:utilisateurs-lepatron}\xspace}
