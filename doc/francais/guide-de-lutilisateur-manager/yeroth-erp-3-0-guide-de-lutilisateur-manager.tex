...
\newcommand{\yerothpgititle}{Yeroth--pgi--$3.0$\xspace}

\newcommand{\yerothpgialerttroiszero}{\textcolor{yerothColorBlue}{\sc YEROTH--PGI--SYSTEM-DAEMON--$3.0$}\xspace}
...
\newcommand{\yeroth}{\textcolor{yerothColorBlue}{\sc YEROTH--PGI--$3.0$}\xspace}
\newcommand{\yerothalert}{\emph{yeroth--pgi--system--daemon--3.0}\xspace}
...
\title{\textcolor{medgreen}{\textsc{PROGICIEL DE GESTION INTÉGRÉ \\
		 PGI
		\\ \vspace*{1.5cm}(\yeroth)\\}
		\vspace*{3cm}
