...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
	pdftitle={Brochure d'information du \pos \yerothpgi par: ''\myfullacademicname''},
...
\lhead{Brochure D'information du \pos \yerothpgiblack}
\lfoot{{\small Auteur: \myfullacademicname}}
\rfoot{{\small Version du --~$16$~Mai~$2021$~--}}
\cfoot{\thepage}
...
\input{yeroth-erp-3-0-taches-utilisateurs-table}
