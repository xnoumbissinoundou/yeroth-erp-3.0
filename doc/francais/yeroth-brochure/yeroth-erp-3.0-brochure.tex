...
\newcommand{\patronb}{\textbf{<< Manager >>}\xspace}
...
\textbf{T\^aches} 							& \patronb		 & \vendeurb	 		&	\gestionairedestocksb	& \magasinierb		& \caissierb 		\\ \hline
...
\label{fig:fenetre-de-la-caisse}
\end{figure}
...
\begin{enumerate}[1)]
	...
	\item une interface ''ventes'' qui aide le \manager a
	      ...
	      ventes~(voir la Figure~\ref{fig:fenetre-de-la-caisse})
