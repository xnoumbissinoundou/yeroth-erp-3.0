...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
	pdftitle={Manuel de l'Utilisateur ''Magasinier'' de YEROTH-ERP (version $3.0$)
...
\title{\textcolor{medgreen}{\textsc{Syst\`eme--Logiciel Point--De--Vente avec Gestion des Stocks
		\\ \vspace*{1.5cm}(\yeren)\\}
		\vspace*{3cm}
	Manuel de l'Utilisateur\\ \vspace{1em} << Magasinier >>}}
...
\input{../introduction}
\input{../yeroth-user-tex-file/magasinier/yeren-magasinier}
