...
\newcommand{\yerothpgisystemdaemon}{YEROTH--PGI--$3-0$--SYSTEM-DAEMON\xspace}
...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
	pdftitle={\yerothpgiblack | UTILISATIONS RECOMMANDÉS: R\'edig\'e
...
\newcommand{\qtcreator}{\texttt{Qt--creator}\xspace}
...
\newcommand{\yerothpurplish}[1]{\textcolor{purplish}{#1}\xspace}
\newcommand{\yerothvert}[1]{\textcolor{yerothColorGreen}{#1}\xspace}
\newcommand{\yerothpurplishbf}[1]{\textbf{\textcolor{purplish}{#1}}\xspace}
...
\rhead{\yerothpgiblack Software--System Architecture}
...
{\bf \Large \yerothrd} {| \sc \scriptsize \yerothpgiblack guide pratique du SYSTÈME--LOGICIEL YEROTH-ERP-3.0}
\\ \line(1,0){540}
...
\input{yeroth-erp-3-0-introduction.tex}

\input{yeroth-erp-3-0-CAS-DENTREPRISES.tex}

\input{yeroth-erp-3-0-conclusion.tex}
...
\input{yeroth-erp-3-0-CAS-PHILOSOPHIE-DESIGN-YEROTH_ERP_3_0}

\newpage

\input{yeroth-erp-3-0-OPEN-SOURCE}
