...
\headerrowONE{\cvitempositionheld{ASSISTANT D'ENSEIGNEMENT} (test et qualité du logiciel)}
...
de communication '\texttt{DMIP}' pour la radio-thérapie avec '\texttt{LINAC}--Siemens')}
