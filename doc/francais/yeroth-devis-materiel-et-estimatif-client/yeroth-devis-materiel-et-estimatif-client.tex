...
\newcommand{\yerothpgi}{\textsc{YEROTH--PGI--$3.0$}\xspace}
...
{\bf \Large \yerothrd} {| \sc \scriptsize \yerothpgi devis estimatif d'installation}
\\ \line(1,0){540}

\vspace{3.5em}


\parbox{27em}{\LARGE \yerothpgi Devis Estimatif D'installation pour X (DOUALA, et YAOUND\'E).}
...
copie \yerothpgi								& $\mathbf{2}$  		& $\mathbf{1}$		&	 	 \\ 
\hspace{2em}\textbf{environ localement:} 
