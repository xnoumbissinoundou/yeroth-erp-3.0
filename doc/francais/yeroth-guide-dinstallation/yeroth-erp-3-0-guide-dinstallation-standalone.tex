...
\rhead{Guide d'installation pour le \erp \yerotherpblack}
...
{\bf \Large \yerothrd} {| \sc \scriptsize guide d'installation de \yerotherpblack}
\\ \line(1,0){540}

\vspace{2.0em}

\begin{center}
{\LARGE Guide D'installation pour le Système--Logiciel ERP \yerotherpblack}
\end{center}
