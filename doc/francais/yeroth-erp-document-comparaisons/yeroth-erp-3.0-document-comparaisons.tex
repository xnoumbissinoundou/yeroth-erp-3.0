...
\newcommand{\sageerp}{Sage Apin\'egoce i$7$\xspace}
...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
	pdftitle={\yerotherp, comparaisons de \logicielerp,
	 		   \'edit\'ee, par: ''\myfullacademicname''},
...
\begin{enumerate}
	...
	\item interface du logiciel r\'eduite au stricte minimum
	\item langage simplifi\'ee dans le logiciel
...
\textbf{formation compr\'ehensive}		&
		\yerothvert{$5$ jours}			&
		\yerothorange{$1$ mois}			&						
		\yerothrouge{$2$ mois}			\\ \hline
...
\textbf{formation comptable}	&
		\yerothvert{jamais}		&
		\yerothvert{jamais}		&						
		\yerothrouge{utile}		\\ \hline		

\textbf{formation commerciale}	&
		\yerothvert{jamais}		&
		\yerothorange{utile}	&						
...
\textbf{connection internet}		&
		...
		\yerothrouge{obligatoire}	\\		
\end{tabular}
\caption{Tableau comparatif de quelques logiciels ERP avec \yerotherp\\}
...
\begin{itemize}[]
	\itemsep 0em
	\item[\mycheckmark{yerothColorDarkgray}] Lecteur de codes--barres, etc.\\
\end{itemize}
\begin{center}
