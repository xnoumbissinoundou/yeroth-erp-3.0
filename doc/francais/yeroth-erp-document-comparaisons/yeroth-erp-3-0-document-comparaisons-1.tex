...
\rfoot{{\small Version du --~$24$~Mai~$2021$~--}}
\cfoot{}
...
\subsection{LARGE DIMENSION GÉOGRAPHIQUE}

$1$ LARGE DIMENSION GÉOGRAPHIQUE DES BATIMENTS
DE L'ENTREPRISE PEUT CAUSER DES PERTES DE TEMPS
DANS LES DÉPLACEMENTS pour \textbf{comptabiliser des stocks}.

\vspace{-0.2em}

\subsection{NOMBRE DE SUCCURSALES ÉLEVÉS}

$1$ NOMBRE DE SUCCURSALES ÉLEVÉS DE L'ENTREPRISE
PEUT ENTRAÎNER BEAUCOUP DE PERTES DE TEMPS pour
\textbf{comptabiliser des stocks}.

\vspace{-0.2em}

\subsection{QUANTITÉ TOTALE ÉLEVÉE D'ARTICLES À VENDRE, TRANSFÉRER}

$1$ QUANTITÉ TOTALE ÉLEVÉE D'ARTICLES À VENDRE, ET À 
TRANSFÉRER PEUT ENTRAÎNER DES PERTES DE TEMPS \textbf{durant
la comptabilisation des stocks}.

\vspace{-0.2em}

\subsection{TRAVAIL SIMULTANÉ ET COORDONÉ SUR LES DONNÉES}

TRAVAILLER SIMULTANÉMENT EN GROUPE SUR LES DONNÉES DE STOCKS
À VENDRE, OU À TRANSFÉRER, sans outils informatiques rend \textbf{la
comptabilisation et l'affectation des états de stocks extrênement
difficile !}
...
\textbf{large dimension géographique de l'organisation}&
		\yerothrouge{extrênement difficile}					&
		\yerothrouge{extrênement difficile}					&
		\yerothvert{facile}					   	   \\  \hline 	
		
\textbf{nombre de succursales élevé}		&
		\yerothrouge{extrênement difficile}		&
		\yerothrouge{extrênement difficile}		&						
		\yerothvert{facile}	\\ \hline
	
\textbf{quantité totale élevée d'articles à vendre, transférer}&
		\yerothrouge{extrênement difficile}				&
		\yerothorange{très difficile}					&						
		\yerothvert{facile}						\\ \hline
				
\textbf{travail simultané et coordoné sur les données}	&
		\yerothrouge{extrênement difficile}						&
		\yerothorange{très difficile}							&						
		\yerothvert{facile}				   					   \\
\end{tabular}}
