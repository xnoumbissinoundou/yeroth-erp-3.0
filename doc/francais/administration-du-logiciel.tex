...
\newpage
\input{yeroth-administration/administration-alertes}
\newpage

%-----------------------------------------------------------

\input{yeroth-administration/administration-categories}
\newpage

%-----------------------------------------------------------

\input{yeroth-administration/administration-clients}
\newpage

%-----------------------------------------------------------

\input{yeroth-administration/administration-fournisseurs}
\newpage

%-----------------------------------------------------------

\input{yeroth-administration/administration-utilisateurs}
\newpage

%-----------------------------------------------------------

\input{yeroth-administration/administration-localisations}
