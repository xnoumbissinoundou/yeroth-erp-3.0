...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
	pdftitle={\yerotherpblack Software--System Architecture.
...
{\bf \Large \yerothrc} {| \sc \scriptsize \yerotherpblack software--system architecture}
\\ \line(1,0){540}

\vspace{2.0em}

\begin{center}
{\LARGE \yerotherpblack Software--System Architecture}
\end{center}
...
\input{yeroth-erp-3-0-thick-client-VS-web-browser-software-system-architecture}
