...
\newcommand{\definition}[1]{\textbf{\textcolor{yerothColorBlue}{#1}}\xspace}
...
\input{thick-client-vs-webbrowserbased-software-system-architecture}

\input{the-thick-client-software-system-architecture-of-yeroth-erp-3-0}

\input{related-software-system-architectures}
