...
\newcommand{\sap}{SAP Business One\xspace}
...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
	pdftitle={Advantages of \yerotherpblack compared to other top ERP
...
\newcommand{\yerothtresfacile}{\yerothvert{very easy}\xspace}
...
{\bf \Large \yerothrd} {| \sc \scriptsize advantages of \yerotherpblack compared
				to other top ERP software--systems}
...
compared to other top ERP software--systems ''\sageerp'',
and ''\sap''.\\
...
complete training (or solution) 			&
		\yerothvert{$5$ days}				&
		\yerothorange{at least $2$ months}	&	
		\yerothrouge{at least $3$ months}	\\ \hline
