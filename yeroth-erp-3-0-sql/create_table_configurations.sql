...
insert into configurations (id, nom_configuration, description_configuration, valeur_configuration) values (3, "CONFIG_SALES_STRATEGY", "Configuration de la stratégie de vente/sortie", "CMUP");
