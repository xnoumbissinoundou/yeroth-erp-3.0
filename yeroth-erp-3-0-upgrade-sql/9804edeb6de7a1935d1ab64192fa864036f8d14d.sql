...
alter table charges_financieres ADD column `nom_departement_produit` varchar(256) NOT NULL AFTER reference;
...
UPDATE charges_financieres SET nom_departement_produit='drugs_healthcare';
